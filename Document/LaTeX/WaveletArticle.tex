...
Condition 2 guarantees that: TODO Insert frequency domain tiling:
\begin{figure}[htpb]
  \centering
  \includegraphics[draft,width=0.9\linewidth]{figures/spatial_resolution_fft.pgf}
  \caption{Frequency domain tiling}
  \label{fig:frequency_tiling}
\end{figure}
\end{proposition}
