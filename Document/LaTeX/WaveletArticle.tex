...
%     http://www.itk.org/
%
% NOTE: not working with xelatex
% Change standalone mode, from `buildnew` to images to get xelatex compat. Or use lua*tex, pdflatex.
...
% \endif
% minted requires pygmentize and python-pygmentize.
...
% buildnew: compile files only if source file is newer than image/pdf (not working with xelatex)
% Require --shell-scape: http://ctan.mackichan.com/macros/latex/contrib/standalone/standalone.pdf
\usepackage[subpreambles=true,mode=buildnew]{standalone}
% \usepackage[subpreambles=true,mode=image]{standalone}
% \graphicspath{ {tikz/} }
...
\begin{figure}[H]
  \begin{subfigure}[t]{.33\textwidth}
    ...
    \includestandalone{tikz/freq_time_grid1}
  ...
  \begin{subfigure}[t]{.33\textwidth}
    ...
    \includestandalone{tikz/freq_time_grid2}
    \captionsetup{width=0.8\textwidth}
  ...
  \begin{subfigure}[t]{.33\textwidth}
    ...
    \includestandalone{tikz/freq_time_grid3}
    \captionsetup{width=0.8\textwidth}
...
\begin{figure}[H]
  \begin{subfigure}[t]{\textwidth}
    \centering
    % \input{tikz/wavelet_pyramid_analysis.tex}
    \includestandalone{tikz/wavelet_pyramid_analysis}
    \captionsetup{width=0.8\textwidth}
  ...
  \begin{subfigure}[t]{\textwidth}
    \centering
    \includestandalone{tikz/wavelet_pyramid_reconstruction}
    % \input{tikz/wavelet_pyramid_reconstruction.tex}
    \captionsetup{width=0.8\textwidth}
...
\begin{figure}[H]
  \centering
  \includestandalone{tikz/wavelet_pyramid_analysis_simple}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[t]{.49\textwidth}
    \centering
    \includegraphics[width=0.99\textwidth]{profileMotherWavelet_Vow_5_SubBands.png}
    \captionsetup{width=\textwidth}
    \caption{Vow.}
  ...
  \begin{subfigure}[t]{.49\textwidth}
    \centering
    \includegraphics[width=0.99\textwidth]{profileMotherWavelet_Held_5_SubBands.png}
    \captionsetup{width=\textwidth}
    \caption{Held.}
  ...
  \begin{subfigure}[t]{.49\textwidth}
    \centering
    \includegraphics[width=0.99\textwidth]{profileMotherWavelet_Simoncelli_5_SubBands.png}
    \captionsetup{width=\textwidth}
    \caption{Simoncelli.}
  ...
  \begin{subfigure}[t]{.49\textwidth}
    \centering
    \includegraphics[width=0.99\textwidth]{profileMotherWavelet_Shannon_5_SubBands.png}
    \captionsetup{width=\textwidth}
    \caption{Shannon.}
