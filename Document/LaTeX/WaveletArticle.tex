...
\begin{figure}[H]
  \begin{subfigure}[t]{.49\textwidth}
    \centering
    \includegraphics[width=\textwidth]{profileMotherWavelet_Vow_5_Mother.png}
  ...
  \begin{subfigure}[t]{.49\textwidth}
    \centering
    \includegraphics[width=\textwidth]{profileMotherWavelet_Held_5_Mother.png}
    \captionsetup{width=\textwidth}
    \caption{Held.}
  ...
  \begin{subfigure}[t]{.49\textwidth}
    \centering
    \includegraphics[width=\textwidth]{profileMotherWavelet_Simoncelli_5_Mother.png}
    \captionsetup{width=\textwidth}
    \caption{Simoncelli.}
  ...
  \begin{subfigure}[t]{.49\textwidth}
    \centering
    \includegraphics[width=\textwidth]{profileMotherWavelet_Shannon_5_Mother.png}
    \captionsetup{width=\textwidth}
    \caption{Shannon.}
...
Currently, the size of input image has to be a multiple of two, but the implementation has the member \inline {m_ScaleFactor} for future extension and relaxation of this constraint.
